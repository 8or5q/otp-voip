...
wget https://github.com/8or5q/otp-voip/raw/master/build/ubuntu/otp-voip_1.0.2_all.deb
sudo gdebi --non-interactive otp-voip_1.0.2_all.deb
#sudo dpkg -i otp-voip_1.0.2_all.deb
